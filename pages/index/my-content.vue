<template>
	<view class="my-page" :style="$themeStyle">
		...
		<u-navbar :leftIconSize="0" title="个人中心" :placeholder="true" :autoBack="false" :fixed="false" />
		<!-- 头部 -->
		<view class="my-header">
			<!-- <view class="my-header__glow" /> -->
			<image class="my-header__texture" src="https://cdn.huibaitech.com/qrcode/public/1_94_9.png"
				mode="aspectFill" />
		...
		<view class="my-card">
			<view class="my-card__badge" @click="dian">
				<image src="https://saas888.huibaitech.com/images/upload/applets/0701Card.png" alt="" />
			</view>
			<view class="my-card__level">
				<u-icon name="integral" color="var(--color-secondary)" size="20" />
		...
		<view class="my-body">
			...
			<view class="my-section">
				...
				<view class="my-section__grid">
					<view class="my-section__item" v-for="(it, idx) in orderItems" :key="idx" @click="dingdan(idx)">
						<view class="my-section__icon-box">
							<u-icon :name="it.icon" color="var(--color-primary)" size="24" />
						</view>
						<text>{{ it.label }}</text>
					</view>
				</view>
			...
			<view class="my-section" v-if="infoList.IsBindMember == true">
				...
				<view class="my-section__grid">
					<view class="my-section__item" @click="car">
						<view class="my-section__icon-box">
							<u-icon name="grid-fill" color="var(--color-primary)" size="24" />
						</view>
						<text>会员卡包</text>
					</view>
					<view class="my-section__item" @click="quan">
						<view class="my-section__icon-box">
							<u-icon name="coupon-fill" color="var(--color-primary)" size="24" />
						</view>
						<text>优惠券</text>
					</view>
					<view class="my-section__item" @click="balance">
						<view class="my-section__icon-box">
							<u-icon name="file-text-fill" color="var(--color-primary)" size="24" />
						</view>
						<text>余额流水</text>
					</view>
					<view class="my-section__item" @click="manber">
						<view class="my-section__icon-box">
							<u-icon name="red-packet-fill" color="var(--color-primary)" size="24" />
						</view>
						<text>充值</text>
					</view>
					<view class="my-section__item" @click="undMenber" v-if="infoList.EnableAppletSelfRefund == 1">
						<view class="my-section__icon-box">
							<u-icon name="minus-circle" color="var(--color-primary)" size="24" />
						</view>
						<text>余额退款</text>
					</view>
				</view>
			...
			<view class="my-section">
				...
				<view class="my-section__grid my-section__grid--wrap">
					<view class="my-section__item" @click="ziliao">
						<view class="my-section__icon-box">
							<u-icon name="account-fill" color="var(--color-primary)" size="24" />
						</view>
						<text>个人资料</text>
					</view>
					<view class="my-section__item" @click="quan" v-if="ButtonPermission.CouponButton == 1">
						<view class="my-section__icon-box">
							<u-icon name="coupon-fill" color="var(--color-primary)" size="24" />
						</view>
						<text>优惠券</text>
					</view>
					<view class="my-section__item" @click="fenxiao" v-if="ButtonPermission.DistributionButton == 1">
						<view class="my-section__icon-box">
							<u-icon name="share-fill" color="var(--color-primary)" size="24" />
						</view>
						<text>分销中心</text>
					</view>
					<view class="my-section__item" @click="hexiao" v-if="ButtonPermission.OTAFaceCheckButton == 1">
						<view class="my-section__icon-box">
							<u-icon name="scan" color="var(--color-primary)" size="24" />
						</view>
						<text>自助核销</text>
					</view>
					<view class="my-section__item" @click="jianyi" v-if="ButtonPermission.ReclamoButton == 1">
						<view class="my-section__icon-box">
							<u-icon name="chat-fill" color="var(--color-primary)" size="24" />
						</view>
						<text>投诉建议</text>
					</view>
					<view class="my-section__item" @click="jiuyuan" v-if="ButtonPermission.SoccorsoButton == 1">
						<view class="my-section__icon-box">
							<u-icon name="phone-fill" color="var(--color-primary)" size="24" />
						</view>
						<text>一键救援</text>
					</view>
					<view class="my-section__item" @click="jihuo" v-if="ButtonPermission.ActivateTicketButton == 1">
						<view class="my-section__icon-box">
							<u-icon name="checkmark-circle-fill" color="var(--color-primary)" size="24" />
						</view>
						<text>激活票码</text>
					</view>
					<view class="my-section__item" @click="realNameFun" v-if="ButtonPermission.IDCardAuthButton == 1">
						<view class="my-section__icon-box">
							<u-icon name="account" color="var(--color-primary)" size="24" />
						</view>
						<text>实名认证</text>
					</view>
				</view>
			...
			<!-- 底部信息 -->
			<view class="my-footer" v-if="infoList.CompanyName != '' || infoList.CompanyName != null">
		...
		<!-- 会员码弹窗 -->
		<u-popup :show="show" round="20" closeable mode="center" @close="close" @open="open">
			<view class="popup-qrcode">
				<view class="popup-qrcode__title">会员码</view>
				<view class="popup-qrcode__img">
					<u-qrcode ref="uqrcodeRef" v-if="show" cid="qrcode" :val="infoList.CardID" :size="120" />
				</view>
