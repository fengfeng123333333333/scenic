  ...
  <view class="car-page" :style="$themeStyle">
    ...
    <template v-else>
      ...
      <view class="car-page__header">
        <image
          class="car-page__avatar"
          :src="memberInfo.FaceImgUrl"
          mode="aspectFill"
        />
      ...
      <view class="car-page__actions">
        <view class="car-page__action" @click="goToMembers(0)">
          ...
          <text class="car-page__action-extra"
            >剩余{{ memberInfo.MyCountPackage }}次数卡</text
          >
        </view>
        <view class="car-page__action" @click="goToMembers(1)">
          ...
          <text class="car-page__action-extra"
            >剩余{{ memberInfo.MyTimePackage }}时效卡</text
          >
        </view>
      </view>
    </template>
